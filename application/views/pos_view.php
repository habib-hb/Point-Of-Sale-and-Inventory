...
<html>
<head>
	<title>POS and Inventory Management System</title>
...
<a href="<?php echo base_url('logout/out') ?>"><button style="float: right; margin-top: 6px; margin-right: 20px;" class="btn btn-danger" >Logout</button></a>
...
<div class="main">
	<div style="padding: 0 0px;">
		<div class="col-sm-6">
		<h3 style="float: left;">POS System - Cart View</h3>
		</div>
		<div class="col-sm-6">
		<?php $total_amount = ""; ?>
